...
set_property -dict { PACKAGE_PIN M18    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz

set_property -dict { PACKAGE_PIN M17    IOSTANDARD LVCMOS33 } [get_ports { rst }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
